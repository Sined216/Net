...
TABLE_NOTES = {
    ...
    "connector_types": "Разъёмы портов: RJ45, SFP+, LC. У клетки (SFP) разъём даёт вставленный модуль.",
    "transceiver_modules": "Модули в клетки: что вставлено и какой разъём даёт наружу.",
