 ...
 *
 * Состав редактируется здесь же, а не только перетаскиванием на схеме:
 * когда устройств в группе десятки, тащить каждое мышью — работа на полчаса.
 */
      ...
      <form onSubmit={handleSubmit}>
        <Stack>
          ...
          <Text size="xs" c="dimmed">
            Устройство можно перенести и мышью — перетащите его в нужную рамку прямо на схеме.
          </Text>
