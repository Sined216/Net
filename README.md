...
- **Схема связей.** Автоматическая раскладка по кабелям (ELK): ядро сети
  слева, за ним цеховые коммутаторы, за ними железки. Перетаскивание узлов
  с сохранением позиции и привязкой к сетке: карточки встают серединами по
  её узлам, чтобы кабели между ними шли прямо, а шаг сетки настраивается.
  Цвет линии по шаблону связи, разводка — в обход чужих карточек, со
  скруглёнными углами; ширина коридоров, стороны выхода и крепление кабеля
  к карточке настраиваются в отдельной панели «Разводка». Слева — панель с
  деревьями (группы, теги, типы, модели, VLAN): выбор ветки подсвечивает на
  схеме то, что к ней относится, остальное гаснет.
- **Группировка.** Вложенные теги (устройство может иметь несколько) и
  отдельно — группа устройства (ровно одна), своим списком в «Классификации».
